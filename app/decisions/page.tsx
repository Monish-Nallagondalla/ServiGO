...
const DECISIONS: Decision[] = [
  ...
  },
  {
    id: 'D002',
    category: 'Strategy',
    title: 'Three revenue streams cover payroll — parts margin is the growth lever',
    problem: 'Partners are on a fixed ₹30,000/month salary regardless of job count. The ₹100 platform fee alone at 96 jobs/partner/month = ₹9,600 — not enough to cover payroll. The question is: what combination of revenue streams makes the unit economics work, and which one scales?',
    options: [
      { label: 'Platform fee only — raise it to ₹500+', pro: 'Simple, visible revenue per booking.', con: 'Feels like a tax on the customer. Competitors undercut. Does not scale with booking value.' },
      { label: 'Service charge + platform fee only (no parts markup)', pro: 'Simpler pricing, no inventory risk.', con: 'Service charge barely covers payroll. No margin left for ops, growth, or risk.' },
      { label: 'Three streams: service charge + platform fee + parts markup', pro: 'Service charge covers payroll. Platform fee is the anchor. Parts markup is the growth and margin lever. Each stream serves a different purpose.', con: 'Requires inventory management. Working capital tied up in parts stock.' },
    ],
    chosen: 'Three revenue streams: service charge (covers partner payroll), platform fee (₹100 transparency anchor), parts markup (32% — primary margin and growth lever).',
    rationale: 'The customer invoice bundles parts, service charge, platform fee, and GST into one transparent total. The service charge (₹300–500/job) collected across ~96 jobs/partner/month = ₹33,600 — enough to cover the ₹30,000 fixed salary with a small surplus. The ₹100 platform fee adds ₹9,600/partner/month. Parts markup at 32% on ~₹1,20,000 parts GMV/partner/month = ₹38,400. Total revenue per partner: ₹81,600 against ₹31,200 cost (payroll + ops kit). Net: ₹50,400 per partner per month. Parts markup is the number that compounds — it grows with tier mix, booking frequency, and inventory efficiency.',
    measure: 'Blended gross margin per booking. Target: >32% on parts, service charge breakeven on payroll within 10% variance. If parts margin falls below 28%, audit procurement cost before cutting service charge.',
    insight: 'The business is designed so that service charges make partners cost-neutral and parts markup is pure upside. Every improvement in inventory turn, tier mix, or booking frequency flows directly to the bottom line without touching partner compensation.',
  },
  {
    id: 'D003',
    category: 'Product',
